...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('css/font-awesome/solid.min.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ asset('css/font-awesome/svg-with-js.min.css') }}" rel="stylesheet" type="text/css">
